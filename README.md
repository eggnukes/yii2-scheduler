...
```
php composer.phar require eggnukes/yii2-scheduler "*"
```

or add

```json
"eggnukes/yii2-scheduler": "*"
```
...
<?php
/**
 * @var \eggnukes\scheduler\Schedule $schedule
 */
...
First of all, you should include dependency to the `eggnukes\yii2-scheduler` into your composer.json:
...
```php
'schedule' => 'eggnukes\scheduler\Schedule',
```
